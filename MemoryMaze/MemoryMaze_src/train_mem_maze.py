...
# python3 -W ignore MemoryMaze/MemoryMaze_src/train_mem_maze.py --model_mode 'RATE' --arch_mode 'TrXL' --ckpt_folder 'v2_RATE' --text 'RATE'
...
if __name__ == '__main__':
    ...
    for RUN in range(start_seed, end_seed+1):
        ...
        print(f"Selected Model: {config['model_mode']}, Max traj. length: {max_length}") 
        ...
        #==============================================================================================================================#
        wandb_step = 0
        model = train(ckpt_path, config, train_dataloader, mean, std, max_segments, experiment=None)
