...
def get_returns_VizDoom(wandb,model, ret, seed, episode_timeout, context_length, device, act_dim, config, mean, std, use_argmax=False, create_video=False):
    ...
    env = env_vizdoom2.DoomEnvironmentDisappear(wandb=wandb,
        scenario=config_env,
        show_window=False,
        use_info=True,
